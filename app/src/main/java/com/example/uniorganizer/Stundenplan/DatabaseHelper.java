...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_CREATE = "create table " + DATABASE_NAME + "("+ENTRY_ID + "integer primary key autoincrement, " + ENTRY_NAME + " text not null, " + ENTRY_ROOM + " text not null,"+ ENTRY_START_H +" text not null,"+ ENTRY_START_MIN + " text not null," + ENTRY_END_H + " text not null," + ENTRY_END_MIN + " text not null," + ENTRY_WEEKDAY+ " );";
